...
for i in range(len(links_list)) :
    ...
    try:
        ...
        page_source = session.get(dochtm_link, allow_redirects = True, headers = user_agent_header, verify = False).text


        with open(links_list[i] + ".html", "w", encoding="UTF-8") as file:
